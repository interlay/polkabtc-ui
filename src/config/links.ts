...
const INTERLAY_MEDIUM = 'https://medium.com/interlay';
const INTERLAY_LINKEDIN = 'https://www.linkedin.com/company/interlay';

const USER_FEEDBACK_FORM = 'https://forms.gle/JXBoRdspbG8pMs3k6';
